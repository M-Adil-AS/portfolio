...
const processData = () => {
  return singleProjectRawData.map((rawProject) => {
    ...
    let categories = projectsData
      .filter((project) => rawProject.id.includes(project.id))
      .map((project) => project.category);

    let relatedProjects = projectsData.filter(
      (project) =>
        categories.includes(project.category) &&
        !rawProject.id.includes(project.id),
    );
    ...
    relatedProjects.forEach((rp) => {
      let count = projectsData.filter(
        (p) => p.title == rp.title && categories.includes(p.category),
      ).length;
      rp.count = count;
    });
...
let singleProjectRawData = [
  {
    ...
    ProjectHeader: {
      title: "Crosswords",
      publishDate: "Dec 28, 2021",
      tags: "Game Dev - Problem Solving",
    },
    ProjectImages: [
    ...
    ProjectInfo: {
      ...
      Technologies: [
        { title: "Tools & Technologies", techs: ["HTML", "CSS", "JavaScript"] },
      ],
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To build a Doodle Jump game which gets harder to play over time",
      CodeUrlHeading: "Code",
      ...
      ProjectDetails: [
        ...
        },
        {
          id: 2,
          details:
            "It makes use of concepts like infinite scrolling of game objects and background. The game gets more difficult to play with the increase in score value.",
        },
      ],
      Instructions: [
        {
          id: 1,
          details: "ArrowUp to shoot, ArrowLeft and ArrowRight to move",
        },
      ],
    },
  },

  {
    ...
    ProjectInfo: {
      ...
      demoUrlHeading: "Demo",
      demoUrl:
        "https://drive.google.com/file/d/1klF4rYgar6jXCH0wyQdRtzDPzpXtS6iz/view?usp=drive_link",
      Technologies: [
        {
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To implement K-Means Clustering Algorithm and visualize using graph",
      CodeUrlHeading: "Code",
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To implement K-Nearest Neighbor Algorithm and visualize using graph",
      CodeUrlHeading: "Code",
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To build Tetris Browser Game having all main features",
      CodeUrlHeading: "Code",
...

  {
    ...
    ProjectInfo: {
      ...
      Instructions: [{ id: 1, details: "Arrow Keys to play the game" }],
    },
  },
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "Develop a Keyboard Piano program that provides a virtual musical experience",
      CodeUrlHeading: "Code",
      ...
      Technologies: [
        {
          title: "Tools & Technologies",
          techs: ["HTML", "CSS", "JavaScript", "Tone JS"],
        },
      ],
      ProjectDetailsHeading: "Description",
      ProjectDetails: [
      ...
      Instructions: [
        ...
        {
          id: 2,
          details: "Black Notes (From Exclamation Key to Backspace Key)",
        },
      ],
    },
  },

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To find the Code which satisfies the given five conditions",
      CodeUrlHeading: "Code",
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To build Ping Pong Game in which player plays against AI",
      CodeUrlHeading: "Code",
      ...
      Instructions: [
        {
          id: 1,
          details: "Move Paddle by pressing and holding down keys 'W' and 'S'",
        },
      ],
    },
  },

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To solve 8 puzzle problem optimally using A* algorithm",
      CodeUrlHeading: "Code",
      ...
      Instructions: [
        {
          id: 1,
          details: "Click on the browser screen to start the algorithm.",
        },
        {
          id: 2,
          details:
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To implement Perceptron Learning Algorithm and visualize using graph",
      CodeUrlHeading: "Code",
...

  {
    ...
    ProjectHeader: {
      ...
      publishDate: "Aug 16, 2023",
      tags: "Web Application - AI",
    },
    ProjectImages: [
      {
        id: 1,
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To build a web application which allows users to keep track of all of their job interviews in one place",
      CodeUrlHeading: "Code",
      codeUrl: "https://github.com/M-Adil-AS/InterVU-backend",
      demoUrlHeading: "Demo",
      demoUrl:
        "https://drive.google.com/file/d/1Or25iGQEBUF-OxT-zClzDiA6-eHNL1-y/view?usp=sharing",
      Technologies: [
        {
          title: "Tools & Technologies",
          techs: [
...

  {
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To implement ETL pipeline using Node JS streams and MongoDB",
      CodeUrlHeading: "Code",
      codeUrl: "https://github.com/M-Adil-AS/ETL-Project",
      demoUrlHeading: "Demo",
      demoUrl:
        "https://drive.google.com/file/d/1q7BXTg1h_q6PIKDpyAEFbiCJZLskrkMt/view?usp=sharing",
      Technologies: [
        {
          title: "Tools & Technologies",
          techs: [
...

  {
    ...
    ProjectHeader: {
      ...
      tags: "AI - Game Dev - Problem Solving",
    },
    ProjectImages: [
    ...
    ProjectInfo: {
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To build Tic Tac Toe game and implement Minimax Algorithm to enable Computer to play against Human",
      CodeUrlHeading: "Code",
...

  {
    ...
    ProjectImages: [
      { id: 1, title: "SymposAI Platform", img: Sympos2 },
      { id: 2, title: "SymposAI Platform", img: Sympos3 },
      { id: 3, title: "SymposAI Platform", img: Sympos4 },
    ],
    ProjectInfo: {
      ...
      CompanyInfo: [
        ...
        },
        {
          id: 2,
          title: "Website",
          details: "https://divdash.com/",
        },
      ],
      ObjectivesHeading: "Objective",
      ObjectivesDetails:
        "To develop an AI-powered platform leveraging multiple LLM agents to propose, challenge, and refine ideas through structured debate, to enhance decision-making quality.",
      demoUrlHeading: "Demo",
      ...
      ProjectDetails: [
        {
          id: 1,
          details:
            "Engineered a Multi-Agent Debate Engine orchestrating 5 persona-driven LLM agents per session.",
        },
        {
          id: 2,
          details:
            "Implemented WebSockets-based real-time streaming to support structured, turn-based agent interactions.",
        },
        {
          id: 3,
          details:
