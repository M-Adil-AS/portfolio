    ...
    <div className="block sm:flex gap-0 sm:gap-10 mt-6 sm:mt-14">
      <div className="w-full sm:w-1/3 text-left">
        ...
        <div className="mb-7">
          ...
          <a
            href={onlyCurrentProject.ProjectInfo.demoUrl}
            className="font-general-regular text-primary-dark dark:text-ternary-light hover:underline hover:text-indigo-500 dark:hover:text-indigo-400 cursor-pointer duration-300"
          >
            Project Preview
          </a>
        </div>
        ...
        {/* URLs code */}
        {onlyCurrentProject.ProjectInfo.codeUrl &&
          onlyCurrentProject.ProjectInfo.CodeUrlHeading && (
            <div className="mb-7">
              ...
              <a
                href={onlyCurrentProject.ProjectInfo.codeUrl}
                className="font-general-regular text-primary-dark dark:text-ternary-light hover:underline hover:text-indigo-500 dark:hover:text-indigo-400 cursor-pointer duration-300"
              >
        ...
        {onlyCurrentProject.ProjectInfo.ClientHeading && (
          <div className="mb-7">
            ...
            <ul className="leading-loose">
              {onlyCurrentProject.ProjectInfo.CompanyInfo.map((info) => {
        ...
        <div className="mb-7">
          ...
          <p className="font-general-regular text-primary-dark dark:text-ternary-light techContainer">
            {onlyCurrentProject.ProjectInfo.Technologies[0].techs.map(
              (tech, index) => {
                return (
                  <span className="font-general-regular bg-ternary-light dark:bg-ternary-dark techSpan">
                    {tech}
                  </span>
                );
              },
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-5 flexWrap">
            {onlyCurrentProject.ProjectInfo.SocialSharing.map((social) => {
              return (
                <a
                  key={social.id}
                  href={social.url}
                ...
                >
                  <span className="text-xl lg:text-2xl">{social.icon}</span>
                </a>
              );
            })}
          </div>
