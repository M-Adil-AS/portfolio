...
const ProjectSingle = ({ title, category, image, demoURL, codeURL }) => {
  ...
  return (
    ...
    >
      <Link
        to={`/projects/single-project/${slugify(title)}`}
        ...
        <div className="rounded-xl shadow-lg hover:shadow-xl cursor-pointer mb-10 sm:mb-0 bg-secondary-light dark:bg-ternary-dark">
          <div className="iconsContainer">
            {codeURL && (
              ...
              >
                <img
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, rgb(141, 141, 145), rgb(0, 0, 0))",
                  }}
                  alt="githubIcon"
                />
              </a>
            ...
            <a
              href={demoURL}
              aria-label="Demo"
              className={codeURL ? "demoIconLink" : "githubIconLink"}
              target="_blank"
              rel="noreferrer"
              onClick={(e) => gotoURL(e, "demo")}
            >
              <img
                src={demoIcon}
                className="demoIcon"
